...
def mobilenet():
    ...
    model = layers.Conv2D(64, 3, padding="same", name="conv_layer_0")(model)

    model = layers.Activation("relu")(model)

    model = layers.Conv2D(128, 3, padding="same", name="conv_layer_1")(model)
    ...
    model = layers.SeparableConv2D(30, kernel_size=5, strides=1, activation="relu")(model)
